    ...
    return (
        <Form {...form}>
            <div className='flex justify-center w-full'>
                <AxeIcon width={40} height={40} className='mt-1 mb-2 text-theme dark:text-theme-foreground' />
            </div>
            <h1 className='py-1 text-3xl text-center'>Welcome back</h1>
            <h1 className='py-1 text-sm text-center text-muted-foreground'>Sign in to your account</h1>
            ...
            <div className='mt-5 mb-1 flex gap-1.5 justify-center items-center'>
